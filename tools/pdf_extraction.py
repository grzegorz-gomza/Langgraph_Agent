...
#     text_summaries = text_summary_agent.invoke(extracted_text=texts)
#     table_summary_agent = TableSummaryAgent(
#             state=state,
#             model=model,
#             server=server,
#             guided_json=None,
...
#             model_endpoint=model_endpoint,
#             temperature=temperature)
#     table_summaries = table_summary_agent.invoke(extracted_table=tables)
#     image_summaries_agent = ImageSummaryAgent(
#         state=state,
#             model=model,
#             server=server,
#             guided_json=None,
...
#             model_endpoint=model_endpoint,
#             temperature=temperature)
#     image_summaries = image_summaries_agent.invoke(extracted_images=images)
