...
class ClaudModel:
    def __init__(self, temperature=0, model=None):
        ...
        self.model = "claude-3-haiku-20240307" if model == "" else model
    ...
    def invoke(self, messages):
        ...
        # prompt = f"{anthropic.HUMAN_PROMPT} system:{system}. {user}{anthropic.AI_PROMPT}"
        ...
        #     )
        #     return HumanMessage(content=response.get("completion", ""))
